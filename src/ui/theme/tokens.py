...
REQUIRED_TOKEN_KEYS: List[str] = [
    ...
    "yellow",
    "yellow-dim",
    # Timeline (custom-painted widget colors)
    "timeline-base-border",
    "timeline-base-fill",
    "timeline-disabled-fill",
    "timeline-selected-fill",
    "timeline-selected-border",
    "timeline-enabled-fill",
    "timeline-handle-fill",
    "timeline-playhead",
    "timeline-text",
    "purple",
    "accent-primary",
